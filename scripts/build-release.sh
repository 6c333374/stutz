...
function usage()
{
    ...
    echo "and generates the checksum files of the Stutz tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/maze2k1/stutz.git"
CLONE_DIR="$BUILD_DIRECTORY/stutz-buildall"
TARGET_DIR="$BUILD_DIRECTORY/stutz-releases"
DYNAMIC_RELEASE="stutz-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="stutz-${TAG_VERSION}-linux-staticboost-CLI"
